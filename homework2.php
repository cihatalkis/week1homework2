...
if($gender === 'male'){
    $calculation = 88.362 + (13.397 * $weight) + (4.799 * $height - (5.677 * $age));
}else {
    $calculation = 447.592 + (9.247 * $weight) + (3.098 * $height - (4.330 * $age));
}


if($calculation < $guess){
    print('BMR: ' .$calculation .'Tahmin Degerinden düşük');
}else if($calculation > $guess){
    print('BMR: ' .$calculation .'Tahmin Degerinden büyük');
}else {
    print('BMR: ' .$calculation .'Tahmin Degeriyle eşit');
}
